...
object RateBasedJobConfig extends BuildJobConfig {
...
object RateBasedBuildJob
    extends BuildJobTemplate(RateBasedJobConfig)
    with RequiredBinaryComparatorsExecutionApp
object ScheduledRateBasedBuildJob extends ScheduledBuildJobTemplate(RateBasedJobConfig)
