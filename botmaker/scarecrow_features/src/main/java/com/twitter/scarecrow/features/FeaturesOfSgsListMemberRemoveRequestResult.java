...
import com.twitter.socialgraph.thriftjava.ListRemoveMemberRequest;
import com.twitter.socialgraph.thriftjava.ListRemoveMemberRequestResult;
...
public class FeaturesOfSgsListMemberRemoveRequestResult extends FeatureMapExtractor {

  private final ListRemoveMemberRequest request;
  private final LogEventContext context;
  private final FeaturesOfTwitterContext twitterContexts;

  public FeaturesOfSgsListMemberRemoveRequestResult(
      ListRemoveMemberRequestResult requestResult,
