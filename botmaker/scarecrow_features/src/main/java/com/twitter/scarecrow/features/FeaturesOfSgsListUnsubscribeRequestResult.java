...
import com.twitter.socialgraph.thriftjava.ListUnsubscribeRequest;
import com.twitter.socialgraph.thriftjava.ListUnsubscribeRequestResult;
...
public class FeaturesOfSgsListUnsubscribeRequestResult extends FeatureMapExtractor {

  private final ListUnsubscribeRequest request;
  private final LogEventContext context;
  private final FeaturesOfTwitterContext twitterContexts;

  public FeaturesOfSgsListUnsubscribeRequestResult(
      ListUnsubscribeRequestResult requestResult,
