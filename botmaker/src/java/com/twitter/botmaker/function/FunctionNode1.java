...
public abstract class FunctionNode1<E, T1> extends ASTNode<E> {

  public FunctionNode1(
    ...
    if (isFunctor(childExtractors)) {
      return new FunctionExtractor<E>(this, childExtractors) {
        ...
        public Future<Object> evaluate(Context<E> context, List<Object> args) {
          try {
            Object result = FunctionNode1.this.apply(this, context, (T1) args.get(0));
        ...
        public Object apply(Context<E> context) throws Exception {
          ...
          return FunctionNode1.this.apply(this, context, arg1);
        }
      };
    } else {
