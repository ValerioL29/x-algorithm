...
public abstract class FunctionNode2O1<E, T1, T2, O1> extends ASTNode<E> {

  public FunctionNode2O1(
      String exprText, ImmutableList<ASTNode> children) throws SemanticCheckFailure {
    super(exprText, children);
    assertChildrenSize(exprText, children, 2, 3);
  }
    ...
    if (isFunctor(childExtractors)) {
      return new FunctionExtractor<E>(this, childExtractors) {
        ...
        public Future<Object> evaluate(Context<E> context, List<Object> args) {
          try {
            if (childExtractors.size() == 2) {
              Object result = FunctionNode2O1.this.apply(
                  this, context, (T1) args.get(0), (T2) args.get(1));
              return Future.value(result);
            } else {
              Object result = FunctionNode2O1.this.apply(
                  this, context, (T1) args.get(0), (T2) args.get(1), (O1) args.get(2));
              return Future.value(result);
            }
          } catch (Throwable e) {
        ...
        public Object apply(Context<E> context) throws Exception {
          ...
          if (childExtractors.size() == 2) {
            return FunctionNode2O1.this.apply(this, context, arg1, arg2);
          } else {
            O1 opt1 = (O1) childFunctors.get(2).apply(context);
            return FunctionNode2O1.this.apply(this, context, arg1, arg2, opt1);
          }
        }
      };
    } else {
  ...
  protected Object apply(
      Extractor<E> extractor, Context<E> context, T1 arg1, T2 arg2, O1 opt1) throws Exception {
    try {
      return apply(context, arg1, arg2, opt1);
  ...
  protected abstract Object apply(
      Context<E> context, T1 arg1, T2 arg2, O1 opt1) throws Exception;
  ...
  protected abstract Object apply(Context<E> context, T1 arg1, T2 arg2) throws Exception;
}
