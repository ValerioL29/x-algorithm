...
@BotMakerFunction(
    ...
    returnType = "Set<T>",
    description = "Returns a new set containing the given elements.",
    actionLevel = ActionLevel.NO_ACTION,
    examples = {
        "Set(1, 2, 3)"
    }
)
public class SetOperator extends FunctionNode<Runtime> {
  ...
  public SetOperator(String exprText, ImmutableList<ASTNode> children)
  ...
  protected Object apply(Context<Runtime> context, List<Object> args) {
    return Collections.unmodifiableSet(new HashSet<>(args));
  }
}
