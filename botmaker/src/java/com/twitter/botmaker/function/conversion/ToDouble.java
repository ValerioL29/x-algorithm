...
@BotMakerFunction(
    argTypes = {"Object"},
    arguments = {"string to convert to a double"},
    returnType = "Double",
    description = "Double representation of the string.",
    actionLevel = ActionLevel.NO_ACTION,
    examples = {
        "ToDouble(\"1234567\")"
    }
)
public class ToDouble extends FunctionNode1<Runtime, Object> {
  ...
  public ToDouble(String exprText, ImmutableList<ASTNode> children)
