...
public class Equals extends FunctionNode2<Runtime, Object, Object> {
  private static final Signature SIGNATURE = new Signature(
      ImmutableList.of(Type.OBJECT, Type.OBJECT),
      Type.BOOLEAN
  );

  public Equals(String exprText, ImmutableList<ASTNode> children) throws SemanticCheckFailure {
