...
@BotMakerFunction(
    ...
    returnType = "Double",
    description = "Rounds a number up to the nearest long.",
    actionLevel = ActionLevel.NO_ACTION,
    examples = {
        "Ceil(-1.8)"
    }
)
public class Ceil extends FunctionNode1<Runtime, Number> {
  private static final Signature SIGNATURE = new Signature(
      ImmutableList.of(Type.NUMBER),
      Type.DOUBLE
  );

  public Ceil(String exprText, ImmutableList<ASTNode> children) throws SemanticCheckFailure {
