...
public class IndexOf extends FunctionNode2O1<Runtime, String, String, Long> {
  ...
  public IndexOf(String exprText, ImmutableList<ASTNode> children) throws SemanticCheckFailure {
  ...
  protected Long apply(
    ...
    return (long) str.indexOf(substr, index.intValue());
  }
}
