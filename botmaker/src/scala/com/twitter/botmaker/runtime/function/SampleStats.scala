...
object SampleStats extends FunctionUnit2[TwitterRuntime, List[String], Long, Unit] {
  ...
  override def description =
    "Adds a percentile stat sample: botmaker/<app>/botstats/<name1>/<name2>/..."
  ...
  override def evaluate(
    ...
    if (statNames.forall(CharMatcher.ascii.matchesAllOf)) {
      ...
      context.getRuntime.statsReceiver.stat(names: _*).add(value)
    }
  }
}
