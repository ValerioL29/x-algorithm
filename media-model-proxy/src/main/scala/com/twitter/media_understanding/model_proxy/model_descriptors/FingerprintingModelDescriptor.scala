...
class FingerprintingModelDescriptor @Inject() (features: Features) extends ModelDescriptor {
  override val model = MediaModel.Fingerprinting
  ...
  override def serviceBuilders() = {
    List(
      DeepbirdClient.Builder(
        ...
        3000.milliseconds,
        features.fingerprintingModelV1,
      )
    )
  }
}
