...
class FingerprintingV2ModelDescriptorSpec extends FunSuite with MockitoSugar {
  private[this] val mediaFeatureId = new Feature.Tensor(
    "magicpony.media_fingerprinting.image",
    JavaDType.UINT8
  ).getFeatureId
  private[this] val descriptor = new FingerprintingV2ModelDescriptor(new NullFeatures)
