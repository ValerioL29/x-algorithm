...
class HatefulSymbolRecognitionModelDescriptorSpec extends FunSuite with MockitoSugar {
  private[this] val mediaFeatureId = new Feature.Tensor(
    "magicpony.hateful_symbol_recognition.image",
    JavaDType.UINT8
  ).getFeatureId
  private[this] val descriptor = new HatefulSymbolRecognitionModelDescriptor(new NullFeatures)
