...
object Configs {
  ...
  final val adsRole = "ads-prediction"
  ...
  final val TwhinUserHalfLife: Duration = 1.day
  final val TwhinUserHalfLifeInMs: Long = TwhinUserHalfLife.inMillis

  final val TwhinUserNegativeHalfLife: Duration = 14.day
  final val TwhinUserNegativeHalfLifeInMs: Long = TwhinUserNegativeHalfLife.inMillis

  final val TwhinEmbeddingSize: Int = 200
  final val TwhinEps: Double = 0.000000000001d
  ...
  final val AdsOldestTweetEventTimeInMillis = 21.days.inMillis

  final val OldestVideoTweetFavEventTimeInMillis = 7.days.inMillis
